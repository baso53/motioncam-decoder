        ...
        namespace
        {
            ...
            struct UInt16x8
            {
                ...
                UInt16x8(
                    ...
                    const uint16_t p5,
                    const uint16_t p6,
                    const uint16_t p7) : d{p0, p1, p2, p3, p4, p5, p6, p7}
                {
                }

                UInt16x8(const uint16x8_t &src) : d{src}
                {
                }
                ...
                {
                    return UInt16x8(vandq_u16(d, rhs.d));
                }

                INLINE
                UInt16x8 operator|(const UInt16x8 &rhs) const
                {
                    return UInt16x8(vorrq_u16(d, rhs.d));
                }

                INLINE
                UInt16x8 operator<<(const int16_t n) const
                {
                    return UInt16x8(vshlq_u16(d, vdupq_n_s16(n)));
                }
            ...
            {
                return UInt16x8(vmovl_u8(vld1_u8(src)));
            }
            ...
            const uint8_t *Decode6(uint16_t *RESTRICT output, const uint8_t *input)
            {
                ...
                const UInt16x8 r6 =
                    ((p0 >> 6) & L) | (((p1 >> 6) & L) << 2) | (((p1 >> 6) & L) << 2) | (((p2 >> 6) & L) << 4);

                const UInt16x8 r7 =
                    ((p3 >> 6) & L) | (((p4 >> 6) & L) << 2) | (((p5 >> 6) & L) << 4);
            ...
            {
                uint32_t numBlocks =
                    static_cast<uint32_t>(input[offset]) | (static_cast<uint32_t>(input[offset + 1]) << 8) | (static_cast<uint32_t>(input[offset + 2]) << 16) | (static_cast<uint32_t>(input[offset + 3]) << 24);
            ...
            {
                encodedWidth =
                    static_cast<uint32_t>(input[0]) | (static_cast<uint32_t>(input[1]) << 8) | (static_cast<uint32_t>(input[2]) << 16) | (static_cast<uint32_t>(input[3]) << 24);

                encodedHeight =
                    static_cast<uint32_t>(input[4]) | (static_cast<uint32_t>(input[5]) << 8) | (static_cast<uint32_t>(input[6]) << 16) | (static_cast<uint32_t>(input[7]) << 24);

                bitsOffset =
                    static_cast<uint32_t>(input[8]) | (static_cast<uint32_t>(input[9]) << 8) | (static_cast<uint32_t>(input[10]) << 16) | (static_cast<uint32_t>(input[11]) << 24);

                refsOffset =
                    static_cast<uint32_t>(input[12]) | (static_cast<uint32_t>(input[13]) << 8) | (static_cast<uint32_t>(input[14]) << 16) | (static_cast<uint32_t>(input[15]) << 24);
            }
